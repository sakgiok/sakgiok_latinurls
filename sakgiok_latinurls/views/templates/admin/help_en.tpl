    ...
    <div class="bootstrap" id="sg_latinurlshelpblock">
        <div class="panel">
            <div class="panel-heading" onclick="$('#sg_latinurls_help_panel').slideToggle();">
                ...
                {if $update.res == 'update'}
                    &nbsp;<span class="sg_latinurls_update_title_success">A NEW UPDATE IS FOUND!</span>
                {elseif $update.res == 'current'}
                    &nbsp;<span class="sg_latinurls_update_title_current">NO UPDATE FOUND!</span>
                {elseif $update.res == 'error'}
                    &nbsp;<span class="sg_latinurls_update_title_error">ERROR DURING UPDATE CHECK!</span>
                {/if}
            </div>
        {/if}
        <div id="sg_latinurls_help_panel"{if $help_ajax == false && $hide == true} style="display: none;"{/if}>
            ...
            <div class="sg_latinurls_help_body">
                <p>This module allows you to convert any non latin product urls to latin ones. This can happen automatically when a new product is added or on demand for existing products.</p>
